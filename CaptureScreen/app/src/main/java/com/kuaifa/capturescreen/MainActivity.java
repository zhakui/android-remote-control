...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.kuaifa.capturescreen.R.layout.activity_main);
        mScreenShortBtn = (Button) findViewById(com.kuaifa.capturescreen.R.id.btn_screen_short);
        mScreenRecordBtn = (Button) findViewById(com.kuaifa.capturescreen.R.id.btn_screen_record);
